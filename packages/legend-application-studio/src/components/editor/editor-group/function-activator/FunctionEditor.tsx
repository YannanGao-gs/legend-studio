...
export enum FUNCTION_PROMOTE_TYPE {
  ...
  REFINER = 'Refiner',
  SNOWFLAKE_NATIVE_PERSISTENCE = 'Snowflake Native Persistence',
}
  ...
  (props: {
    ...
    const renderFunctionPromoteTypes = (type: string): React.ReactNode => {
      switch (type) {
        case FUNCTION_PROMOTE_TYPE.SNOWFLAKE_NATIVE_APP:
          return (
            <BaseCard
              ...
              cardContent="Deploy the function as a UDTF in snowflake"
              isActive={
        ...
        case FUNCTION_PROMOTE_TYPE.SNOWFLAKE_NATIVE_PERSISTENCE:
          return (
            <BaseCard
              key={FUNCTION_PROMOTE_TYPE.SNOWFLAKE_NATIVE_PERSISTENCE}
              cardMedia={<div className="coming-soon-label"> Coming Soon</div>}
              cardName={type}
              cardContent="Use the function in the definition of a Store persistence"
              isDisable={true}
              isActive={
                activatorPromoteState.promoteType ===
                FUNCTION_PROMOTE_TYPE.SNOWFLAKE_NATIVE_PERSISTENCE
              }
              onClick={() => {
                activatorPromoteState.setPromoteType(type);
              }}
        ...
        <Modal darkMode={true} className="function-promote-editor">
          ...
          <ModalFooter>
            ...
            <ModalFooterButton
              ...
              disabled={!activatorPromoteState.promoteType}
