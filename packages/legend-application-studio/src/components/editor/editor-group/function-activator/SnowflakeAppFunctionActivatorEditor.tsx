...
import {
  type SnowflakeAppDeploymentConfiguration,
...
} from '../../panel-group/SQLPlaygroundPanel.js';
...
export const SnowflakeAppFunctionActivatorEditor = observer(() => {
  ...
  const initializeActivationConnection = (
    ...
    return !val
      ? undefined
      : (
          editorState.activator
            .activationConfiguration as SnowflakeAppDeploymentConfiguration
        ).activationConnection?.packageableConnection.value;
  };

  const activationConnection =
    editorState.activator.activationConfiguration &&
    (
      editorState.activator
        .activationConfiguration as SnowflakeAppDeploymentConfiguration
    ...
    <div className="snowflake-app-function-activator-editor">
      <Panel>
        ...
        <PanelContent>
            ...
            <div className="snowflake-app-function-activator-editor__configuration__items">
              <div className="snowflake-app-function-activator-editor__configuration__item">
                ...
                <CustomSelectorInput
                  ...
                  darkMode={true}
                  placeholder="Choose a connection or Default to server connection"
          ...
          <PanelForm>
            <PanelFormTextField
              value={editorState.activator.applicationName}
              name="Activator Identifer"
              placeholder="Specify an identifer for this activator..."
          ...
          <PanelForm>
            <div className="panel__content__form__section">
              ...
              <textarea
                ...
                spellCheck={false}
                value={editorState.activator.description}
          ...
          <PanelForm>
            <PanelFormTextField
              value={editorState.activator.owner}
              placeholder="(Kerberos)"
              name="Owner"
              update={(value: string | undefined): void =>
                editorState.updateOwner(value ?? '')
              }
            />
          </PanelForm>
        </PanelContent>
