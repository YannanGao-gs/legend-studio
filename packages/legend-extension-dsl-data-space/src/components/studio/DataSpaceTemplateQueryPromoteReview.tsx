...
const TemplateQueryPromotionReviewerContent = observer(() => {
  ...
  const toggleIsAutoConfigurationEnabled = (): void =>
    queryPromotionReviewerStore.setIsAutoConfigurationEnabled(
      !queryPromotionReviewerStore.isAutoConfigurationEnabled,
    );
            ...
            <div className="template-query-promotor__content__main">
              ...
              <div className="template-query-promotor__group template-query-promotor__group--workspace">
                ...
                <div className="template-query-promotor__group__content">
                  ...
                  <div className="template-query-promotor__auto-configuration">
                    <div
                      className="template-query-promotor__auto-configuration__toggler"
                    ...
                    >
                      <div className="panel__content__form__section__toggler">
                        ...
                        <div className="panel__content__form__section__toggler__prompt">
                          ...
                          runtimes, etc.) by adding query`s project as a
                          dependency in your workspace to work well with the
                          specfied query
                        </div>
                      </div>
                    </div>
                    <div className="template-query-promotor__auto-configuration__hint">
                      <div
                        className="template-query-promotor__auto-configuration__hint__icon"
                        title={
                          'If the project`s master branch already contains entities from query`s versioned entities, check Auto-configure will introduce compilation failures as there are duplcated elements'
                        }
                      >
                        <QuestionCircleIcon />
                      </div>
                    ...
                    <div className="input-group template-query-promotor__input__input">
                      <input
                        className={clsx(
                          ...
                          {
                            'input-group__input--error':
                              !queryPromotionReviewerStore.isTemplateQueryTitleValid,
                          },
                        )}
                        spellCheck={false}
