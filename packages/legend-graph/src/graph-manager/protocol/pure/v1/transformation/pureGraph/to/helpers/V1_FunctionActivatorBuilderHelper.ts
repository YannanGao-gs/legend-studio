...
import type { ConnectionPointer } from '../../../../../../../../graph/metamodel/pure/packageableElements/connection/Connection.js';
import { SnowflakeAppDeploymentConfiguration } from '../../../../../../../../graph/metamodel/pure/packageableElements/function/SnowflakeAppDeploymentConfiguration.js';
...
export const V1_buildSnowflakeAppDeploymentConfiguration = (
  ...
  if (element.activationConnection) {
    const activationConnection = V1_buildConnection(
