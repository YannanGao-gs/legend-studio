...
export class QueryFunctionsExplorerState {
  ...
  functionInfoMap?: Map<string, QueryBuilderFunctionInfo>;
  packagePathToFunctionInfoMap?: Map<string, QueryBuilderFunctionInfo[]>;
  ...
  setFunctionInfoMap(info: Map<string, QueryBuilderFunctionInfo>) {
    this.functionInfoMap = info;
  }

  setPackagePathToFunctionInfoMap(
    map: Map<string, QueryBuilderFunctionInfo[]>,
  ) {
